...
- [ ] **Jandex index:** `jandex-maven-plugin` in runtime `pom.xml` — **required** for REST client interfaces and CDI beans to be discoverable at build time. Without it, `RestClientBuilder.build()` fails with `"was not indexed at build time"`.
